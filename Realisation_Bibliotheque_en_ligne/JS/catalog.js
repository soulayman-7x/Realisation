...
let library = JSON.parse(localStorage.getItem('library')) || [
  ...
  { code: 3, title: "Jane Eyre", author: "Charlotte Brontë", year: 1847, available: true, price: 0, image: "BOOKS/Jane-Eyre.png" },
  { code: 4, title: "Meditations", author: "Marcus Aurelius", year: 180, available: true, price: 250, image: "BOOKS/Meditations.png" },
  { code: 5, title: "Moby Dick", author: "Herman Melville", year: 1851, available: true, price: 0, image: "BOOKS/Moby-Dick.png" },
  ...
  { code: 8, title: "The Art of War", author: "Sun Tzu", year: -500, available: true, price: 0, image: "BOOKS/The-Art-of-War.png" },
...
function updateState(expensiveCount) {
  ...
  let freeBooks = library.filter(book => book.price === 0).length;
  document.getElementById('stats').innerHTML = `
    ...
    <p>Free Books : <span>${freeBooks}</span></p>
  `;
}  
